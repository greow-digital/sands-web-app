...
Har du eternittak ser kalkylen annorlunda ut, eftersom asbestsaneringen tillkommer utöver det nya taket. Vi har räknat på det separat i vår guide om att <a href="/blogg/byta-eternittak-kostnad" class="text-[#2B74FC] font-semibold">byta eternittak</a>.
...
Underlagspapp, ströläkt och bärläkt är de poster som avgör om taket faktiskt blir tätt, och de är samtidigt de som är lättast att missa när man jämför offerter. Vi har gått igenom <a href="/blogg/under-takpannorna-underlagspapp-strolakt" class="text-[#2B74FC] font-semibold">vad som finns under takpannorna</a> och varför det sällan räcker att byta beläggningen.
