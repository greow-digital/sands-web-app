      ...
      <main className="pt-16 lg:pt-20 bg-white">
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `if(typeof gtag!=='undefined'){var txn,src,variant,fid,lsrc,fired;try{txn=sessionStorage.getItem('sands_lead_txn');src=sessionStorage.getItem('sands_lead_source')||'unknown';variant=sessionStorage.getItem('sands_lead_variant')||'unknown';fid=sessionStorage.getItem('sands_lead_formid')||'offert';lsrc=sessionStorage.getItem('sands_lead_leadsource')||fid;fired=sessionStorage.getItem('sands_lead_fired')}catch(e){}if(txn&&fired!==txn){var p={currency:'SEK',value:1500,transaction_id:txn,form_source:src,form_variant:variant,form_id:fid,lead_source:lsrc};gtag('event','form_submit',p);gtag('event','generate_lead',p);try{sessionStorage.setItem('sands_lead_fired',txn)}catch(e){}}}`,
          }}
        />
